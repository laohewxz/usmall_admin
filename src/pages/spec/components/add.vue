  ...
  <div class="add">
    <el-dialog :title="info.title" :visible.sync="info.show">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="add('from')" v-if="info.isAdd">添 加</el-button>
        <el-button type="primary" v-else @click="update('from')">修 改</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        specsname: [
          { required: true, message: "请输入角规格名称", trigger: "blur" },
        ],
      },
  ...
  methods: {
    ...
    add() {
      ...
      this.form.attrs =this.attrArr.map((item) => item.value)+'';
